...
public record GlVertexAttributeFormat(int typeId, int size) {
    ...
    public static final GlVertexAttributeFormat INT = new GlVertexAttributeFormat(GL46C.GL_INT, 4);
    public static final GlVertexAttributeFormat SHORT = new GlVertexAttributeFormat(GL46C.GL_SHORT, 2);
    public static final GlVertexAttributeFormat BYTE = new GlVertexAttributeFormat(GL46C.GL_BYTE, 1);
