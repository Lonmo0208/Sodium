...
public record ModOptions(String namespace, String name, String version, ColorTheme theme, Identifier icon, boolean iconMonochrome, ImmutableList<Page> pages, List<OptionOverride> overrides) implements Searchable {
    @Override
